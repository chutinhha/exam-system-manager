<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeBehind="Lever.aspx.cs" Inherits="ExamSystemManager.Admin.Lever" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlAddnew" runat="server" Visible="false">
        ...
        <table width="600px" style="margin:auto;">
            ...
            <tr>
                <td>Cấp độ :</td><td><asp:TextBox ID="txtLever" runat="server" CssClass="text" 
                    Width="242px"></asp:TextBox></td><td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                    ControlToValidate="txtLever" ErrorMessage="Bạn phải nhập cấp độ"></asp:RequiredFieldValidator>
                </td>
            </tr>
    ...
    <asp:Panel ID="pnlData" runat="server">
        ...
        <asp:GridView ID="gridData" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Lev_ID" HeaderText="Mã" />
                <asp:BoundField DataField="Lev_Name" HeaderText="Cấp độ" />
                <asp:BoundField DataField="Lev_Description" HeaderText="Mô tả" />
                <asp:TemplateField HeaderText="Thao tác">
                    <ItemTemplate>
                        <asp:ImageButton ID="ibtEdit" runat="server" CommandName="cmdEdit" 
                            ImageUrl="~/admin/IMG/icons/pencil.png" ToolTip="Edit" 
                            CommandArgument='<%# Eval("Lev_ID") %>' />
