<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="ExamSystemManager.Admin.Category" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlAddnew" runat="server" Visible="false">
        ...
        <table width="600px" style="margin:auto;">
            ...
            <tr>
                <td>Lĩnh vực :</td><td><asp:TextBox ID="txtName" runat="server" CssClass="text" 
                    Width="242px"></asp:TextBox></td><td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                    ControlToValidate="txtName" ErrorMessage="Bạn phải nhập lĩnh vực"></asp:RequiredFieldValidator>
                </td>
            </tr>
    ...
    <asp:Panel ID="pnlData" runat="server">
        ...
        <asp:GridView ID="gridData" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Cat_ID" HeaderText="Mã" />
                <asp:BoundField DataField="Cat_Name" HeaderText="Lĩnh vực" />
                <asp:BoundField DataField="Cat_Description" HeaderText="Mô tả" />
